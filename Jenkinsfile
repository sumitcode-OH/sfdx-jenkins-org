    ...
    // -------------------------------------------------------------------------
 	...
 	withEnv(["HOME=${env.WORKSPACE}"]) {	
		...
		stage('Authorize to Salesforce') {
			...
			rc = command "sfdx auth:jwt:grant --instanceurl https://login.salesforce.com --clientid 3MVG9kBt168mda_8pPnWxglIfbFGPYvNkKZeYb_wT1TOx_EMPgCXoet5IEU51ywR5o0tJ4ceK5iAFVCl0sT69 --jwtkeyfile /Users/ssaha/JWT/server.key --username ssaha@curious-otter-i702ll.com --setalias UAT"
		    if (rc != 0) {
